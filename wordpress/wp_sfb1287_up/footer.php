    ...
    <div class="row">
        <?php if (ICL_LANGUAGE_CODE == 'de') : ?>
            ...
            <div class="footer-logo">
                ...
                <a target="_blank" href="https://www.uni-potsdam.de/"><img src="<?php echo get_bloginfo('template_directory'); ?>/img/potsdam.png" alt="Logo der UP" loading="lazy" class="up"></a>
            </div>
            <div class="footer-logo">
        ...
        <?php if (ICL_LANGUAGE_CODE == 'en') : ?>
            ...
            <div class="footer-logo">
                ...
                <a target="_blank" href="https://www.uni-potsdam.de/"><img src="<?php echo get_bloginfo('template_directory'); ?>/img/potsdam.png" alt="Logo of the UP" loading="lazy" class="up"></a>
            </div>
            <div class="footer-logo">
                <h3>funded by:</h3>
